...
- **Vanilla CSS3** (Flexbox, CSS Variables, Glassmorphism)
 ...
 ### На ближайшее будущее запланирован следующий функционал:

- [ ] Вкладка "Статистика посещаемости"
- [ ] Вкладка "Статистика рейда"
- [ ] Защита от случайного удаления
- [ ] Подключить облачную БД для хранения данных
- [ ] Свернуть готовое приложение в .exe
