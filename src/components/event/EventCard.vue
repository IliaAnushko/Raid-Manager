...
<template>
   <div v-if="event" class="event-card">
      ...
      <div class="event-info">
        ...
        <div class="tags">
          <span class="tag date-tag">{{ event.date }}</span>
      ...
      <div class="attendance-stats">
         <div class="progress-bar-container">
            <div class="progress-fill" :style="{ width: attendanceStats.percentage + '%', backgroundColor: attendanceStats.color }"></div>
         </div>
...
.details-btn:hover { background: rgba(52, 152, 219, 0.2); }
.edit-btn:hover { background: rgba(241, 196, 15, 0.2); }
